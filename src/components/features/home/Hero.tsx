    ...
    <section className="relative w-screen left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] mb-[25vh] max-lg:mb-[15vh] max-md:mb-[25vh] pt-6 max-md:pt-0 pb-12 max-sm:pb-28">
      ...
      <div
        className={`fixed lg:top-5 z-50 transition-all duration-300 max-sm:w-full   left-0 right-0 ${
          scrolled
            ? "flex max-sm:w-[90%] max-sm:left-0 max-sm:right-0 max-sm:mx-auto bg-secondary/60 backdrop-blur-md shadow-sm py-3 max-md:py-2 w-[95%] lg:w-[80%] left-1/2 right-1/2 -ml-[47.5%] lg:-ml-[40%] -mr-[47.5%] lg:-mr-[40%] rounded-[1.5rem] lg:rounded-full top-2 max-sm:top-6"
            ...
            >
              {config?.logoUrl ? (
                <img
                  ...
                  className={scrolled ? "h-6 w-auto" : "h-7 md:h-8 w-auto max-lg:h-10 max-sm:h-8 "}
                />
              ) : (
                navbar.logo.text
              )}
            ...
            {featureBadges.map((badge, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="border-2 border-gray-400 bg-primary/80 backdrop-blur-sm shadow-sm rounded-2xl p-6 w-50 "
                >
