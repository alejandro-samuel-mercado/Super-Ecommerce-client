  ...
  return (
    <AnimatePresence>
      {show && (
        ...
        >
          <div className="bg-gradient-to-r from-primary/20 to-purple-600/20 w-full h-full flex items-center justify-center">
            <motion.div
                ...
                {logo ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <motion.div
                      ...
                      className="w-20 h-20 border-4 border-t-primary border-r-primary/30 border-b-primary/10 border-l-primary/50 rounded-full"
                    />
                  </div>
                )}
                {/* Anillo Pulsante */}
